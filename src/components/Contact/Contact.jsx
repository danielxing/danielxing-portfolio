...
function Contact() {
  ...
  const contactLinks = [
    ...
    },
    {
      ...
      label: 'Book a Call',
      value: 'Schedule a 30-min meeting',
    ...
    },
    {
      ...
      href: '#wechat',
      description: 'China\'s #1 messaging app',
      isWeChat: true
    }
  ];
  ...
  return (
    <section id="contact" className="contact section">
      <div className="container">
        <div ref={ref} className={`contact-content ${isVisible ? 'animate' : ''}`}>
          <div className="contact-header">
            <span className="section-label">Contact</span>
            <h2 className="section-heading">Let's Work Together</h2>
            <p className="contact-description">
              Ready to expand into China or optimize your existing China marketing strategy?
              ...
              link.isWeChat ? (
                ...
                >
                  ...
                  <div className="contact-link-info">
                    ...
                    <span className="contact-link-description">{link.description}</span>
                  </div>
          ...
          <div className="contact-cta">
            <p className="contact-cta-text">
              Prefer a quick chat? Send me an email with your project details and I'll respond within 24 hours.
            </p>
          </div>
        </div>
      </div>
